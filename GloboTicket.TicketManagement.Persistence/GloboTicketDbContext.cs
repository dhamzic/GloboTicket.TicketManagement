...
namespace GloboTicket.TicketManagement.Persistence
{
    public class GloboTicketDbContext : DbContext
    {
        ...
        {
            //Traži sve konfiguracije (npr. EventConfiguration te ih primjenjuje na ModelBuilder-u
            //Konfiguracije ili ti specifičnost atributa u bazi (obavezan, veličina)
            modelBuilder.ApplyConfigurationsFromAssembly(typeof(GloboTicketDbContext).Assembly);

            #region Ako nema navedene kategorije (has data), dodaj novu
        ...
        {
            //Provjera, ako je podatak novo dodan ili modificiran
